namespace RoliSoft.TVShowTracker.Synchronization.Engines
{
    ...
    /// </summary>
    public class LabSync2 : SyncEngine
    {
        #region Queue
        /// <summary>
        ...
        private readonly string _delayedDataPath = Path.Combine(Signature.AppDataPath, ".sync-delayed-data");
        private readonly string _pendingDataPath = Path.Combine(Signature.AppDataPath, ".sync-pending-data");

        private readonly string _user, _pass;

        /// <summary>
        /// Initializes the <see cref="LabSync"/> class.
        /// </summary>
        static LabSync()
        {
        }
