...
Section -MainProgram
	...
	File "Dependencies\HtmlAgilityPack.License.txt"
	File "Dependencies\IronPython.License.txt"
	File "Dependencies\Microsoft.Dynamic.License.txt"
	File "Dependencies\Microsoft.Scripting.License.txt"
	File "Dependencies\Microsoft.WindowsAPICodePack.License.txt"
	File "Dependencies\Microsoft.WindowsAPICodePack.Shell.License.txt"
	File "Dependencies\Newtonsoft.Json.License.txt"
	File "Dependencies\nunit.framework.License.txt"
	File "Dependencies\SharpCompress.License.txt"
	File "Dependencies\StarksoftBiko.License.txt"
	File "Dependencies\TaskDialog.License.txt"
	File "Dependencies\Transitionals.License.txt"
	File "Dependencies\UPnP.License.txt"
	File "Dependencies\UPNP_AV.License.txt"
	File "Dependencies\UPNPAVCDSML.License.txt"
	File "Dependencies\UPNPAVMSDV.License.txt"
	File "Dependencies\Xceed.Wpf.Toolkit.License.txt"
	File "Dependencies\GreyableImage.License.txt"
...
Section Uninstall
	...
	Delete "$INSTDIR\libs\HtmlAgilityPack.License.txt"
	Delete "$INSTDIR\libs\IronPython.License.txt"
	Delete "$INSTDIR\libs\Microsoft.Dynamic.License.txt"
	Delete "$INSTDIR\libs\Microsoft.Scripting.License.txt"
	Delete "$INSTDIR\libs\Microsoft.WindowsAPICodePack.License.txt"
	Delete "$INSTDIR\libs\Microsoft.WindowsAPICodePack.Shell.License.txt"
	Delete "$INSTDIR\libs\Newtonsoft.Json.License.txt"
	Delete "$INSTDIR\libs\nunit.framework.License.txt"
	Delete "$INSTDIR\libs\SharpCompress.License.txt"
	Delete "$INSTDIR\libs\StarksoftBiko.License.txt"
	Delete "$INSTDIR\libs\TaskDialog.License.txt"
	Delete "$INSTDIR\libs\Transitionals.License.txt"
	Delete "$INSTDIR\libs\UPnP.License.txt"
	Delete "$INSTDIR\libs\UPNP_AV.License.txt"
	Delete "$INSTDIR\libs\UPNPAVCDSML.License.txt"
	Delete "$INSTDIR\libs\UPNPAVMSDV.License.txt"
	Delete "$INSTDIR\libs\Xceed.Wpf.Toolkit.License.txt"
	Delete "$INSTDIR\libs\GreyableImage.License.txt"
