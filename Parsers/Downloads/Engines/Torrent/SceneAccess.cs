namespace RoliSoft.TVShowTracker.Parsers.Downloads.Engines.Torrent
{
    ...
    public class SceneAccess : DownloadSearchEngine
    {
        ...
        public override Version Version
        {
            get
            {
                return Utils.DateTimeToVersion("2011-09-24 3:38 AM");
            }
        }
        ...
        public override bool Deprecated
        {
            get
            {
                // My account on this site has been banned the minute a mod saw I have a Romanian IP address. They have a perfectly sound reasoning: Fuck me because fuck me.</sarcasm>
        ...
        {
            var html = Utils.GetHTML(Site + "browse?method=2&search=" + Utils.EncodeURL(query), cookies: Cookies);
            ...
            var links = html.DocumentNode.SelectNodes("//table[@id='torrents-table']/tr/td[@class='ttr_name']/a");
            ...
            foreach (var node in links)
            {
                ...
                link.FileURL = Site + node.GetNodeAttributeValue("../../td[@class='td_dl']/a", "href");
                link.Size    = node.GetTextValue("../../td[@class='ttr_size']/br/preceding-sibling::text()").Trim();
                link.Quality = FileNames.Parser.ParseQuality(link.Release);
                link.Infos   = Link.SeedLeechFormat.FormatWith(node.GetTextValue("../../td[@class='ttr_seeders']").Trim(), node.GetTextValue("../../td[@class='ttr_leechers']").Trim());
