namespace RoliSoft.TVShowTracker.Parsers.Downloads.Engines.Usenet
{
    ...
    public class NZBsRus : DownloadSearchEngine
    {
        ...
        public override Version Version
        {
            get
            {
                return Utils.DateTimeToVersion("2011-09-20 7:47 PM");
            }
        }
        ...
        {
            var html = Utils.GetHTML(Site + "nzbbrowse.php?searchwhere=title&cat=20s&listname=date&searchtext=" + Utils.EncodeURL(query), cookies: Cookies);
