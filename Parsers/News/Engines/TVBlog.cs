namespace RoliSoft.TVShowTracker.Parsers.News.Engines
{
    ...
    /// <summary>
    /// Provides support reading TV Blog's RSS feed.
    /// </summary>
    [TestFixture]
    public class TVBlog : FeedReaderEngine
    {
        /// <summary>
        ...
        public override Version Version
        {
            get
            {
                return Utils.DateTimeToVersion("2012-04-22 11:20 PM");
            }
        }
        ...
        {
            return ParseFeed(Site + "serial/" + Utils.CreateSlug(query, false) + "/feed/");
        }
    }
}
